...
-keep class com.huyu.sdk.data.* {*;}
-keep class com.huyu.sdk.data.bean.* {*;}

#自定义模块
-keep class com.huyu.sdk.base.*{*;}

-keep class com.huyu.sdk.listener.*{*;}
-keep class com.huyu.sdk.HYSDK{*;}
-keep class com.huyu.game.*{*;}
-keep class com.huyu.sdk.splash.HY_SplashActivity{*;}
-keep class com.huyu.sdk.util.Logger{*;}
-keep class com.huyu.sdk.util.ToastUtils{*;}
-keep class com.huyu.sdk.util.HY_Utils{*;}
